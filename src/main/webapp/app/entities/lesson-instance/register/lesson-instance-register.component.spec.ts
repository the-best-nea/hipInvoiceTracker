...
import { LessonInstanceRegisterComponent } from './lesson-instance-register.component';

describe('Component Tests', () => {
  describe('LessonInstance Management Update Component', () => {
    let comp: LessonInstanceRegisterComponent;
    let fixture: ComponentFixture<LessonInstanceRegisterComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [LessonInstanceRegisterComponent],
        providers: [FormBuilder, ActivatedRoute],
      })
        .overrideTemplate(LessonInstanceRegisterComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(LessonInstanceRegisterComponent);
